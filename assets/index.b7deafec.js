...
`,b=r.button`
  ...
  margin-right: 15px;
  border-radius: 20px;
`,z=()=>a(q,{children:[e(L,{children:"Noice Cafe"}),e(M,{children:"\u597D\u7684\u5496\u5561\u5E36\u7D66\u4F60\u975E\u51E1\u7684\u4E00\u5929"}),a(P,{children:[e(b,{children:"\u6DFA\u5690\u6D41\u5149"}),e(b,{children:"\u66A2\u98F2\u9187\u82B3"})]})]}),J=r.div`
  width: 100%;
  height: 50vh;
  display: flex;
  flex-direction: row;
...
`,U=r.div`
  display: flex;
  flex-direction: column;
`,V=()=>e(T,{id:"contactUs",className:"container",children:a("div",{className:"row",children:[e("h3",{className:"col-12 text-center",children:"\u806F\u7D61\u6211\u5011"}),a(Z,{className:"row",children:[e("iframe",{className:"p-3 col-6",src:"https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d10224.83598413843!2d120.6382787110568!3d24.165765776572254!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x34693dec4ca3a271%3A0xd8b5a337271e60e2!2z6Ie65Lit5ZyL5a625q2M5YqH6ZmiIE5hdGlvbmFsIFRhaWNodW5nIFRoZWF0ZXI!5e0!3m2!1szh-TW!2stw!4v1647277432766!5m2!1szh-TW!2stw",width:"600",height:"400",style:{border:0},allowFullScreen:"",loading:"lazy"}),a(U,{className:"p-3 col-6",children:[a("form",{children:[a("div",{className:"form-group m-3",children:[e("label",{htmlFor:"formGroupExampleInput",children:"\u60A8\u7684\u59D3\u540D"}),e("input",{type:"text",className:"form-control",id:"formGroupExampleInput"})]}),a("div",{className:"form-group m-3",children:[e("label",{htmlFor:"formGroupExampleInput2",children:"\u60A8\u7684\u4FE1\u7BB1"}),e("input",{type:"text",className:"form-control",id:"formGroupExampleInput2"})]}),a("div",{className:"form-group m-3",children:[e("label",{htmlFor:"comment",children:"\u60F3\u5C0D\u6211\u5011\u8AAA\u4EC0\u9EBC"}),e("textarea",{className:"form-control",rows:3,id:"comment",defaultValue:""})]})]}),e("button",{type:"button",class:"btn btn-primary m-3",children:"\u5BC4\u9001"})]})]})]})}),K=r.div`
  ...
  bottom: 0;
  left: 0; */
`,X=()=>e(K,{className:"text-center align-bottom",children:e("p",{children:"Copyright \xA9 Noice caf\xE9 \u8457\u4F5C\u6B0A\u6240\u6709. All rights reserved."})}),Y=()=>a("div",{children:[e(z,{}),e(W,{}),e(H,{}),e(V,{})]}),Q=()=>e("div",{children:e(Y,{})}),ee=[{id:1,name:"CAFE!N \u51A0\u8ECD\u6FFE\u639B\u5496\u5561",img:"https://diz36nn4q02zr.cloudfront.net/webapi/imagesV3/Original/SalePage/7430667/0/637822687920400000?v=1",price:500,quantity:1},{id:2,name:"\u767E\u871C\u82B1\u5712\u5496\u5561\u8C46",img:"http://sc04.alicdn.com/kf/H128c4fdb36fa47208f034c8a961e72d6w.jpg",price:550,quantity:1},{id:3,name:"\u5370\u5C3C\u706B\u5C71\u5496\u5561\u8C46\u6FFE\u639B\u5496\u5561",img:"https://shoplineimg.com/56f26782e37ec6b62e000084/5ecb9db4a63c9c0027efb3d9/800x.jpg?",price:600,quantity:1},{id:4,name:"\u6FFE\u639B\u5F0F\u5496\u5561-\u884C\u5BB6\u9996\u9078\u7D9C\u5408",img:"https://cf.shopee.co.id/file/8827c7da9ba6a060f9f8b6cfa488fe5e",price:770,quantity:1},{id:5,name:"\u6FFE\u639B\u5F0F\u5496\u5561-\u838A\u5712\u55AE\u54C1\u7D9C\u5408",img:"https://auresso.com.my/wp-content/uploads/2020/03/MW-DB_1024x1024@2x.jpg",price:850,quantity:1},{id:6,name:"\u54E5\u502B\u7FE1\u7389\u7CBE\u54C1\u5496\u5561\u8C46",img:"https://42coffeeroasters.com/wp-content/uploads/sites/3/2020/12/WhatsApp-Image-2021-02-06-at-13.24.18-600x600.jpeg",price:200,quantity:1}],ae=r.div`
  display: flex;
  flex-direction: column;
  align-items: flex-end;
`,te=JSON.parse(localStorage.getItem("cart")||"[]"),re=()=>{const{cartNum:d}=c.exports.useContext(h),{setCartNum:i}=c.exports.useContext(h),[t,p]=c.exports.useState(te),o=s=>{if(t===null)console.log("im empty"),localStorage.setItem("cart","[]"),localStorage.setItem("cartNum",1),p(s);else if(t.length!==0&&t.some(u=>u.id===s.id)){for(let u=0;u<t.length;u++)if(t[u].id===s.id)return console.log("u\u5594"),t[u].quantity++,localStorage.setItem("cart",JSON.stringify(t))}else return console.log("\u6C92\u91CD\u8907"),p([...t,s])};localStorage.setItem("cart",JSON.stringify(t));const n=localStorage.getItem("cart"),m=JSON.parse(n);return c.exports.useEffect(()=>{i(m!=null?m.length:0)},[t]),localStorage.setItem("cartNum",d),e("div",{className:"col-lg-9 col-12 py-3 px-5",children:e("div",{className:"row",children:ee.map((s,u)=>e("div",{className:"col-lg-4 pb-5",children:a("div",{className:"card",style:{width:"18rem"},children:[e("img",{className:"card-img-top",src:s.img,alt:"Card image cap"}),a("div",{className:"card-body",children:[e("h5",{className:"card-title",children:s.name}),a(ae,{children:[a("p",{className:"m-1",children:["$",s.price]}),e("button",{className:"btn btn-primary ",onClick:()=>o(s),children:"\u52A0\u5165\u8CFC\u7269\u8ECA"})]})]})]})},u))})})},oe=()=>e("div",{className:"container",children:a("div",{className:"row",children:[e("div",{className:"col-3 vertical-nav py-5",children:a("nav",{className:"nav flex-column",children:[e("a",{className:"nav-link active text-body all-product border-left-color",href:"#",children:"\u6240\u6709\u5546\u54C1"}),e("a",{className:"nav-link text-secondary",href:"#",children:"\u6FFE\u639B\u5496\u5561"})]})}),e(re,{})]})}),le=()=>e("div",{children:e(oe,{})}),N=r.button`
  background-color: white;
  color: gray;
  padding: 5px;
  font-size: 26px;
